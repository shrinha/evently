...
namespace Evently\Services\Infrastructure\DomainObjectGenerator;
...
use Evently\DomainObjects\AbstractDomainObject;
use Evently\Exceptions\NoDefaultValueAvailableForGeneratedDoProperty;
...
class ClassGenerator
{
    ...
    private string $defaultAbstractNamespace = 'Evently\DomainObjects\Generated';

    private string $defaultConcreteNamespace = 'Evently\DomainObjects';
