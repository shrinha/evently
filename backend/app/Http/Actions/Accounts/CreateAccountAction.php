...
use Evently\Exceptions\EmailAlreadyExists;
use Evently\Exceptions\UnauthorizedException;
use Evently\Http\Actions\Auth\BaseAuthAction;
use Evently\Http\Request\Account\CreateAccountRequest;
use Evently\Http\ResponseCodes;
use Evently\Resources\Account\AccountResource;
use Evently\Services\Application\Handlers\Account\CreateAccountHandler;
use Evently\Services\Application\Handlers\Account\DTO\CreateAccountDTO;
use Evently\Services\Application\Handlers\Account\Exceptions\AccountConfigurationDoesNotExist;
use Evently\Services\Application\Handlers\Account\Exceptions\AccountRegistrationDisabledException;
