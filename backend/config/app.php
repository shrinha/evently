...
return [
    ...
    */
    ...
    'providers' => ServiceProvider::defaultProviders()->merge([
         ...
         */
        \Evently\Providers\AppServiceProvider::class,
        \Evently\Providers\AuthServiceProvider::class,
        // App\Providers\BroadcastServiceProvider::class,
        \Evently\Providers\EventServiceProvider::class,
        \Evently\Providers\RouteServiceProvider::class,
        \Evently\Providers\RepositoryServiceProvider::class
