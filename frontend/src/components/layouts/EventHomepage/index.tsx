                            ...
                            <footer className={classes.footerSection}>
                                <div className={classes.footerContent}>
                                    <div className={classes.footerLinks}>
                                        <Anchor
                                            href={getConfig('VITE_TOS_URL', 'https://Evently/terms-of-service?utm_source=event=homepage-footer') as string}
                                        ...
                                        <Anchor
                                            href={getConfig('VITE_PRIVACY_URL', 'https://Evently/privacy-policy?utm_source=event=homepage-footer') as string}
                                            className={classes.footerLink}
                                        >
                                            {t`Terms of Service`}
                                        </Anchor>
